...
var _jqueryMin = require('../vendors/jquery.min.js');
...
var Common = function () {
    function Common(wrap) {
        ...
        this.wrap = (0, _jqueryMin2.default)(wrap);
    }
...
},{"../vendors/jquery.min.js":6}],8:[function(require,module,exports) {
'use strict';
...
var Top250page = function (_common) {
    _inherits(Top250page, _common);

    function Top250page(wrap) {
        _classCallCheck(this, Top250page);
        ...
        _this.$content = _this.wrap.find('.container'); //内容
        return _this;
    }

    _createClass(Top250page, [{
        key: 'init',
        value: function init() {
            this.bind();
            this.start(); //一开始就请求一次
...
},{"../vendors/jquery.min.js":6,"./common.js":12}],9:[function(require,module,exports) {
'use strict';
...
var UsBoxPage = function (_common) {
    _inherits(UsBoxPage, _common);

    function UsBoxPage(wrap) {
        _classCallCheck(this, UsBoxPage);

        var _this = _possibleConstructorReturn(this, (UsBoxPage.__proto__ || Object.getPrototypeOf(UsBoxPage)).call(this, wrap));

        _this.$content = _this.wrap.find('.container'); //内容
        return _this;
    }

    _createClass(UsBoxPage, [{
        key: 'init',
        value: function init() {
            this.start(); //一开始就请求一次
...
},{"../vendors/jquery.min.js":6,"./common.js":12}],10:[function(require,module,exports) {
'use strict';
...
var SearchPage = function (_common) {
    _inherits(SearchPage, _common);

    function SearchPage(wrap) {
        _classCallCheck(this, SearchPage);

        var _this = _possibleConstructorReturn(this, (SearchPage.__proto__ || Object.getPrototypeOf(SearchPage)).call(this, wrap));

        _this.isLoading = false;
        _this.$input = _this.wrap.find('input');
        _this.$btn = _this.wrap.find('.button');
        _this.$content = _this.wrap.find('.container');
        return _this;
    }
    ...
    _createClass(SearchPage, [{
        ...
        key: 'getData',
        value: function getData(keyword, callback) {
            var _this3 = this;
...
},{"../vendors/jquery.min.js":6,"./common.js":12}],4:[function(require,module,exports) {
'use strict';
...
var _top = require('./top250.js');

var _top2 = _interopRequireDefault(_top);

var _beimei = require('./beimei.js');

var _beimei2 = _interopRequireDefault(_beimei);
...
var beimei = new _beimei2.default('#beimei');
var search = new _search2.default('#search');
top.init();
beimei.init();
search.init();
},{"../css/font.css":5,"../css/index.css":7,"../vendors/jquery.min.js":6,"./top250.js":8,"./beimei.js":9,"./search.js":10}],14:[function(require,module,exports) {
